...
function getDifficultySettings(difficulty = "medium") {
  const settings = {
    ...
    hard: {
      userRatingModifier: -0.5,
      opponentRatingModifier: 0.5,
      opponentPointsModifier: 2,
      homeAdvantage: 1,
      awayPenalty: -0.85,
      userAttackDivisor: 27,
      opponentAttackDivisor: 27,
      userDefenceDivisor: 40,
      opponentDefenceDivisor: 32,
      resultVariance: 1,
      opponentPointsCap: 91,
    },
  };
